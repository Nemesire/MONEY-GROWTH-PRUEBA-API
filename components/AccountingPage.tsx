        ...
        <div>
            ...
            <div className="border-b border-slate-700 mb-6">
                <nav className="-mb-px flex space-x-8">
                    ...
                    <button onClick={() => navigate('/categories')} className="whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm border-transparent text-slate-400 hover:text-slate-200 hover:border-slate-500 flex items-center gap-2"><IconList className="w-5 h-5"/>Categorías</button>
                </nav>
            </div>
